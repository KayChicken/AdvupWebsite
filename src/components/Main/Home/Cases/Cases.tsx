...
const Cases = () => {
    ...
    return (
        <section className='relative cases bg-black left-0 w-full pt-[6rem] pb-[9.3rem]'>
            <svg className='absolute right-0 bottom-0 z-0' width="521" height="1115" viewBox="0 0 521 1115" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className='absolute left-0 bottom-0 z-0' width="382" height="635" viewBox="0 0 382 635" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="relative z-[1] container mx-auto max-w-[1340px] mt-[100px]">
                ...
                <div className='relative flex gap-x-[41px] mt-[3rem] h-[25rem]'>


                    <svg className='absolute left-[-120px] top-[-65px] z-[-1]' width="345" height="278" viewBox="0 0 345 278" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M44.3682 0L344.309 260.816L331.014 277.713L0.221491 122.41L44.3682 0Z" fill="#161616" />
                    </svg>

                    <svg className='absolute left-[-230px] top-[150px] z-[-1]' width="369" height="103" viewBox="0 0 369 103" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M65.6232 0.125489L368.653 62.2884L364.919 83.4616L-5.46596e-05 102.87L65.6232 0.125489Z" fill="#161616" />
                    </svg>


                    <svg className='absolute left-[-130px] top-[300px] z-[-1]' width="98" height="60" viewBox="0 0 98 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 24.0087L95.6221 0.0767171L97.7684 6.77668L22.0031 59.3954L0 24.0087Z" fill="#161616" />
                    </svg>


                    <svg className='absolute left-[-130px] bottom-[-100px] z-[-1]' width="351" height="287" viewBox="0 0 351 287" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 208.198L338.646 0.0928497L350.788 17.8363L103.581 286.966L0 208.198Z" fill="#161616" />
                    </svg>


                    <img className='max-w-[39.8rem] w-full h-full object-cover object-center' src={`/img/${slides[selectSlide].img}`} alt="caseimg" />
                    <div className='flex flex-col justify-between'>
                        ...
                        <button className='font-proxiNova font-semibold inline-block bg-white text-black rounded-full py-[15px] px-[25px] max-w-[9.0625rem] transition duration-200 hover:bg-red hover:text-white'>
                            Подробнее
                        </button>
                    </div>
                </div>
